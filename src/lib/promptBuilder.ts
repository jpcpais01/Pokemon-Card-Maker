...
- Match the rendering style to the rarity tier. "ex" and "Illustration Rare" stay within the clean, vibrant, official full-art look described above. "Special Illustration Rare" is the top gallery-quality tier - pick ONE striking, distinctive fine-art technique (e.g. rich oil-painting texture, dramatic chiaroscuro lighting, a luminous watercolor wash, bold ukiyo-e woodblock-inspired linework, ornate art nouveau linework, stained-glass luminosity, intricate ink-wash brushwork, bold pop-art screenprint) and then write the ENTIRE prompt through that technique's visual vocabulary, not as a single closing label. Describe how the Pokemon's own outline, shading, and surface texture read in that technique (while keeping its game-accurate proportions), how the background/environment is built from that technique's characteristic marks and color application, and how light and shadow behave in that medium - the chosen technique should be evident in nearly every sentence of the prompt. Vary which technique you reach for each time so no two Special Illustration Rare cards feel the same.
